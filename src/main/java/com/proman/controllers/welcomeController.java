...
import com.proman.repository.UserRepository;
...
public class welcomeController {
     ...
     *                                   ResponseEntity<User>
     *                                   getUsersById(@PathVariable(value = "id")
     *                                   Long userId) throws
     ...
     * @throws ResourceNotFoundException the resource not found exception
     * 
     *                                   @PutMapping("/users/{id}") public
     *                                   ResponseEntity<User>
     *                                   updateUser(@PathVariable(value = "id") Long
     *                                   userId,
     * @Valid @RequestBody User userDetails) throws ResourceNotFoundException { User
     ...
     *                   deleteUser(@PathVariable(value = "id") Long userId) throws
     *                   Exception { User user = userRepository.findById(userId)
     *                   .orElseThrow(() -> new ResourceNotFoundException("User not
     *                   found on :: " + userId)); userRepository.delete(user);
